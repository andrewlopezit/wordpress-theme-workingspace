...
class CustomRoomsMeta {
  ...
  initHoverAnimation() {
    ...
    this.hoverRoomAnimation = gsap.timeline({
      repeat: -1
    });
  ...
  displaySearchRooms() {
    ...
    this.searchTimer = setTimeout(() => {
      ...
      Object(_modules_Api__WEBPACK_IMPORTED_MODULE_0__["default"])(this.baseEndpointUrl).getPostsByName(this.searchValue).then(result => {
        const {
          data
        } = result;
