...
class SearchPage {
  constructor() {
    ...
    this.searchTimer; // init local variable
  ...
  events() {
    ...
    this.$searchInput.on('keyup', e => {
      ...
      this.searchTimer = setTimeout(() => {
        Object(_index__WEBPACK_IMPORTED_MODULE_0__["api"])(this.siteUrl).getAllPostTypesByFilter(this.filter).then(results => {
          const {
            data
          } = results;
    ...
    data.forEach(val => {
      ...
      template += `<div class="item workspace card border-top-left border--post border--hover" data-geolocation="${val === null || val === void 0 ? void 0 : (_val$location = val.location) === null || _val$location === void 0 ? void 0 : _val$location.location}">
                            ...
                            <div class="card-body">
                                ...
                                ${val !== null && val !== void 0 && val.price_range ? priceRangeTemplate(val === null || val === void 0 ? void 0 : val.price_range, val === null || val === void 0 ? void 0 : val.permalink) : ''}
                            </div>
                        </div>`;
    });
    return template;
    ...
    data.forEach(val => {
      template += `<div class="item workspace card border-top-left border--post border--hover">
                            ...
                            <div class="card-body">
                                ...
                                <h5><a href="${val === null || val === void 0 ? void 0 : val.permalink}">${val === null || val === void 0 ? void 0 : val.post_title}</a></h5>
                                ${val !== null && val !== void 0 && val.capacity ? capacityTemplate(val === null || val === void 0 ? void 0 : val.capacity) : ''} 
                                ${val !== null && val !== void 0 && val.room_rate ? roomRate(val === null || val === void 0 ? void 0 : val.room_rate, val === null || val === void 0 ? void 0 : val.permalink) : ''}
                            </div>
                        </div>`;
    });
    return template;
