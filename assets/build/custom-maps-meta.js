...
/******/ 	return __webpack_require__(__webpack_require__.s = "./inc/custommapsmeta/custom-maps-meta.js");
/******/ })
/************************************************************************/
/******/ ({

/***/ "./inc/custommapsmeta/custom-maps-meta.js":
/*!************************************************!*\
  !*** ./inc/custommapsmeta/custom-maps-meta.js ***!
  \************************************************/
/*! no exports provided */
...
/***/ "./inc/custommapsmeta/js/CustomMapsMeta.js":
/*!*************************************************!*\
  !*** ./inc/custommapsmeta/js/CustomMapsMeta.js ***!
  \*************************************************/
...
class CustomMapsMeta {
  constructor() {
    ...
    this.mapZoom = 13; // local variable
  ...
  displayLocations() {
    if (!this.$txtSearchLocation.val() || this.locationSearchValue === this.$txtSearchLocation.val()) return;
    ...
    this.locationSearchTimer = setTimeout(() => {
      ...
      axios__WEBPACK_IMPORTED_MODULE_0___default()(`https://api.mapbox.com/geocoding/v5/mapbox.places/${this.locationSearchValue}.json?access_token=${this.mapboxtSecretToken}`).then(res => {
        const {
          data: {
            features
          }
...
/******/ });
//# sourceMappingURL=custom-maps-meta.js.map