...
if(!function_exists('workingspace_the_navigation_brand_style')) {
    function workingspace_the_navigation_brand_style() {
        ...
        -moz-mask-size: 100%;
        mask-size: 100%;
        background: '.get_theme_mod('navigation_brand_color').'';

        $brand_navigation_color = (get_theme_mod('is_navigation_svg_allow_modify_color_setting')) ? 'style="'.$mask_css_rules.'"' : workingspace_get_brand_style();
